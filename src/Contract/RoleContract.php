...
namespace pengxuxu\Permission\Contract;
...
interface RoleContract
{
     ...
     * 为当前角色分配一个权限.
     *
     * @param \pengxuxu\Permission\Contract\PermissionContract $permission
     *
     * @return void
     */
     ...
     * 将当前角色分配到指定用户.
     *
     * @param \pengxuxu\Permission\Contract\PermissionContract $user
     *
     * @return void
     */
